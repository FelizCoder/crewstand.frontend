 ...
 * Post Last
 */
export const postLastV1MissionsFlowLastPost = <ThrowOnError extends boolean = false>(options: Options<PostLastV1MissionsFlowLastPostData, ThrowOnError>) => {
    return (options?.client ?? client).post<unknown, PostLastV1MissionsFlowLastPostError, ThrowOnError>({
        url: '/v1/missions/flow/last',
        ...options,
        headers: {
            'Content-Type': 'application/json',
