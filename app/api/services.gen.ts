 ...
 */
export const getVersionV1InfoVersionGet = <ThrowOnError extends boolean = false>(options?: Options<unknown, ThrowOnError>) => {
    return (options?.client ?? client).get<GetVersionV1InfoVersionGetResponse, GetVersionV1InfoVersionGetError, ThrowOnError>({
        ...options,
        url: '/v1/info/version'
    });
};
